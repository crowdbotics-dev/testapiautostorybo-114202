...
## Project Structure
    ...
    ├── testapiautostorybo_114202  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_114202`
...
2. Clone this repo and `cd testapiautostorybo_114202`
